...
{if !$opc}
		<p class="cart_navigation clearfix">
			...
			<input type="submit" name="processAddress" id="id_submit" class="standard-checkout button btn btn-default button-medium" value="{l s='Proceed to checkout'} &raquo; " {if (int)$error_address == 1}disabled="disabled"{/if} />
		</p>
	</form>
{else}
	</div> <!--  end opc_account -->
