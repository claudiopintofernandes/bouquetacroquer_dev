...
<div class="smartblogcomments" id="respond">
    ...
    <h4 class="comment-reply-title" id="reply-title">{l s="Leave a Reply"  mod="smartblog"} <small style="float:right;">
                <a class="button" style="display: none;" href="/wp/sellya/sellya/this-is-a-post-with-preview-image/#respond" 
	...
	<input type="text" tabindex="1" class="inputName form-control grey" value="" name="name">																	
		...
		<td>
			<textarea tabindex="4" class="inputContent form-control grey" rows="8" cols="80" name="comment"></textarea>
		</td>
	</tr>
	{if Configuration::get('smartcaptchaoption') == '1'}
		<tr>
			<td></td><td><img src="{$modules_dir}smartblog/classes/CaptchaSecurityImages.php?width=100&height=40&characters=5&_dc={math equation='rand()'}"></td>
		</tr><tr>
	  ...
	  beforeSend: function() {
		...
		success: function(json) {
			if (json['error']) {
						...
						$('#commentInput').before('<div class="alert alert-warning warning">' + '<i class="icon-warning-sign icon-lg"></i>' + json['error']['common'] + '</div>');
