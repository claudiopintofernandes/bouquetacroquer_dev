...
{foreach from=$data item=row}
		<tr>
			...
			<td>
				<a href="#" class="editable_hours" data-name="hours" data-type="text" data-pk="{$row.id|escape:'intval'}" data-url="{$web_path_controllers|escape:'html':'UTF-8'}/availableweekdays.php?action=update&token={$tokencommon|escape:'html':'UTF-8'}" data-title="Heures de livraison (empty not to display)">{$row.hours|escape:'html':'UTF-8'}</a>
			</td>
			<td>
