							...
							<h3 class="panel-title">
								...
								<span class="pull-right">
									<a href="{$web_path_backoffice|escape:'html':'UTF-8'}">
										<small><span class="glyphicon glyphicon-arrow-left"></span> back to backoffice</small>
									</a>
								</span>								
							</h3>
							...
							<div id="navigation_tabs">
								<ul class="nav nav-tabs">
									{if $showreg == 1}
										...
										<li><a href="{$web_path_controllers|escape:'html':'UTF-8'}availableweekdays.php?token={$tokencommon|escape:'html':'UTF-8'}" data-toggle="tab"><span class="glyphicon glyphicon-calendar"></span> Available Week Days</a></li>
										<li><a href="{$web_path_controllers|escape:'html':'UTF-8'}restricteddays.php?token={$tokencommon|escape:'html':'UTF-8'}" data-toggle="tab"><span class="glyphicon glyphicon-ban-circle"></span> Restricted Days</a></li>									
										{else}
