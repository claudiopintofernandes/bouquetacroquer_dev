...
class Eydatepicker extends Module {
    ...
    public function hookBeforeCarrier($params) {
       ...
       /* if (date('G') >= (int) Configuration::get('PS_CUTOFF_HOUR'))
		...
		/*$datepicker_config_data['datas_min'][$carrier['id_carrier']]= $this->_getMinDates($carrier['id_carrier']);
		$datepicker_config_data['minDates'][$carrier['id_carrier']] = $this->_getMinDates($carrier['id_carrier']);	*/	
