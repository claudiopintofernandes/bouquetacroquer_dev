                ...
                $.getJSON(
                    ...
                    function(response){
                        if(response.success == "true"){
                            showResponse($("#sortable"), "{l s='Saved successfull' mod='pk_bannercarousel'}", 'conf');
                            var i = 1;
                            ...
                            showResponse($("#sortable"), "{l s='Something went wrong, please refresh the page and try again' mod='pk_bannercarousel'}", 'error'); 
                        }
                  }
                );
            }
...
<div id="minic">
    ...
    <div class="header">      
        <div id="navigation">
            <a href="#new" id="new-button" class="minic-open">{l s='Add New' mod='pk_bannercarousel'}</a>
            <a href="#options" id="options-button" class="minic-open">{l s='Options' mod='pk_bannercarousel'}</a>
        </div>
    </div>
    <!-- Options -->
