<?php /* Smarty version Smarty-3.1.19, created on 2016-03-08 01:59:43
         compiled from "/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/themes/alysum/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:194170074656de23ffb67b59-54119371%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '09e117ac8723e6a4231c3a06c7519daf5204e21e' => 
    array (
      0 => '/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/themes/alysum/shopping-cart.tpl',
      1 => 1454463711,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '194170074656de23ffb67b59-54119371',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56de240020fb57_44843822',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56de240020fb57_44843822')) {function content_56de240020fb57_44843822($_smarty_tpl) {?>
...
">
				<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['lastProductAdded']->value['link_rewrite'],$_smarty_tpl->tpl_vars['lastProductAdded']->value['id_image'],('small_').($_smarty_tpl->tpl_vars['cookie']->value->img_name)), ENT_QUOTES, 'UTF-8', true);?>
...
">
  ...
  <?php if ($_smarty_tpl->tpl_vars['errors_category']->value>0) {?>
    <p id="alert_category " class="alert alert-warning">Votre panier contient des bouquets de fruits frais et/ou de l&eacute;gumes. Pour des raisons de qualit&eacute; et de fraicheur, ils ne peuvent &ecirc;tre exp&eacute;di&eacute;s que sur Lyon et sa r&eacute;gion. Merci de bien en tenir compte sur votre adresse de livraison.</p>
  <?php }?>
		...
		<table id="cart_summary" class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart_avail item hidden"><?php echo smartyTranslate(array('s'=>'Avail.'),$_smarty_tpl);?>
</th>
...
<?php }?>" method="post" id="voucher">
											<fieldset>
												<h4 class="hidden"><?php echo smartyTranslate(array('s'=>'Vouchers'),$_smarty_tpl);?>
</h4>
							...
							<table>
								<tr>
									<td class="text-right">
										<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value) {?>
											<?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?>
												...
												<?php } else { ?>
													<?php echo smartyTranslate(array('s'=>'Total products (tax incl.)'),$_smarty_tpl);?>
									...
									<td class="price" id="total_product">
										<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value) {?>
											<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value) {?>
												<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>

											<?php } else { ?>
												<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products_wt']->value),$_smarty_tpl);?>
									...
									<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value!=$_smarty_tpl->tpl_vars['total_shipping']->value) {?>
										<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value) {?>
											<tr class="cart_total_delivery" <?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0) {?> style="display:none;"<?php }?>>
												<td class="text-right"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total shipping (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
										...
										<?php } else { ?>
											<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping']->value<=0) {?> style="display:none;"<?php }?>>
												<td class="text-right"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total shipping (tax incl.)'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
<?php }?></td>
									...
									<?php } else { ?>
										<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0) {?> style="display:none;"<?php }?>>
											<td class="text-right"><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
</td>
											<td class="price" id="total_shipping" ><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value),$_smarty_tpl);?>
</td>
										</tr>
								...
								<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value) {?>
									<tr class="cart_total_price">
										<td class="text-right"><?php echo smartyTranslate(array('s'=>'Total (tax excl.)'),$_smarty_tpl);?>
</td>
									...
									<tr class="cart_total_tax">
										<td class="text-right"><?php echo smartyTranslate(array('s'=>'Total tax'),$_smarty_tpl);?>
</td>
