<?php /* Smarty version Smarty-3.1.19, created on 2016-03-11 14:49:08
         compiled from "/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/modules/pk_layeredslider/views/templates/admin/admin-options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:147615759656e2ccd42fd508-48016940%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9cd0d32c49e2ad8d0cb9e05c10094715efc631cb' => 
    array (
      0 => '/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/modules/pk_layeredslider/views/templates/admin/admin-options.tpl',
      1 => 1453301984,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147615759656e2ccd42fd508-48016940',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e2ccd4461281_11325159',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e2ccd4461281_11325159')) {function content_56e2ccd4461281_11325159($_smarty_tpl) {?>

<fieldset id="option" class="hidden-div">
	<legend><?php echo smartyTranslate(array('s'=>'Options','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
</legend>
...
">
            ...
            <div class="configuration">
                <h3><?php echo smartyTranslate(array('s'=>'Animation Configuration','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
</h3>
                <!--<div>
...
">                    
                ...
                <div>
                    <label><?php echo smartyTranslate(array('s'=>'Pause Time','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
: </label>
					<input type="text" name="pause" value="<?php echo $_smarty_tpl->tpl_vars['slider']->value['options']['pause'];?>
" class="tooltip2" title="<?php echo smartyTranslate(array('s'=>'How long each slide will be shown in miliseconds (default is 3 sec)','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
">
                </div>
                <div class="switch">
                    <label><?php echo smartyTranslate(array('s'=>'Pause on Mouse Hover','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
: </label>
...
" checked="true" />
					...
					<span class="info_ico tooltip2" title="<?php echo smartyTranslate(array('s'=>'Pause the slider on mouse hover.','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
"></span>
                </div>
                <div class="switch">
                    <label><?php echo smartyTranslate(array('s'=>'Auto Rotate','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
: </label>
					<div class="field switch">
...
" checked="true" />
					...
					<span class="info_ico tooltip2" title="<?php echo smartyTranslate(array('s'=>'Turn it OFF if you dont want the slider to auto slide.','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
"></span>
                </div>                    
            </div>
            <div class="navigation">
                <h3><?php echo smartyTranslate(array('s'=>'Navigation','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
</h3>
                <div class="switch">
                    <label><?php echo smartyTranslate(array('s'=>'Prev/Next button','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
: </label>
					<div class="field switch">
...
" checked="true" />
					...
					<span class="info_ico tooltip2" title="<?php echo smartyTranslate(array('s'=>'If you want previous and next buttons on the two side of the slider, then turn this on.','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
"></span>
                </div>
                <div class="switch">
                    <label><?php echo smartyTranslate(array('s'=>'Control','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
: </label>
					<div class="field switch">
...
" checked="true" />
					...
					<span class="info_ico tooltip2" title="<?php echo smartyTranslate(array('s'=>'This controls the navigation, by default these are the litle dots under the slider.','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
"></span>
                </div>
               <!-- <div class="switch">
...
"></span>
            ...
            <div class="other">
                <h3><?php echo smartyTranslate(array('s'=>'Other','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
</h3>
                <!--<div class="switch">
...
">
                ...
                <div class="switch">
                    <label><?php echo smartyTranslate(array('s'=>'I need multilanguage','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
: </label>
					<div class="field switch">
...
" checked="true" />
					...
					<span class="info_ico tooltip2" title="<?php echo smartyTranslate(array('s'=>'Turn on if you want to use different slides for different languages, otherwise the default language slides will be used for all the languages.','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
"></span>
                </div>       
                <!--<div>
...
" checked="true" />
					...
					<span class="info_ico tooltip" title="<?php echo smartyTranslate(array('s'=>'Turn on if you want to use the Minic Slider only on the home page.'),$_smarty_tpl);?>
"></span>
                </div>   -->
            </div>
            <div class="button_cont">
				<input type="submit" name="submitOptions" value="<?php echo smartyTranslate(array('s'=>'Update','mod'=>'pk_layeredslider'),$_smarty_tpl);?>
