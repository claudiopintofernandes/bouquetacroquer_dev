<?php /* Smarty version Smarty-3.1.19, created on 2016-03-21 21:00:22
         compiled from "/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/modules/ph_simpleblog/views/templates/admin/simple_blog_posts/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:44263330956f052d6973ee9-20725153%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2e0783a9d34bb442413508eae61c3997861b265' => 
    array (
      0 => '/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/modules/ph_simpleblog/views/templates/admin/simple_blog_posts/helpers/form/form.tpl',
      1 => 1453301943,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '44263330956f052d6973ee9-20725153',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56f052d79fd832_27905899',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56f052d79fd832_27905899')) {function content_56f052d79fd832_27905899($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/tools/smarty/plugins/function.counter.php';
?>
...
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?>">
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='file'&&$_smarty_tpl->tpl_vars['input']->value['name']=='cover') {?>
...
"<?php }?> />
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='file'&&$_smarty_tpl->tpl_vars['input']->value['name']=='featured') {?>
		<?php if (isset($_smarty_tpl->tpl_vars['input']->value['display_image'])&&$_smarty_tpl->tpl_vars['input']->value['display_image']) {?>
...
"<?php }?> />
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['name']=="tags") {?>
		<?php if (isset($_smarty_tpl->tpl_vars['input']->value['display_tags'])&&$_smarty_tpl->tpl_vars['input']->value['display_tags']) {?>
...
"
							value="<?php echo smarty_modifier_htmlentitiesUTF8($_smarty_tpl->tpl_vars['simpleblogpost']->value->getTags($_smarty_tpl->tpl_vars['language']->value['id_lang'],true));?>
"
							 />
					<?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>
						</div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '44263330956f052d6973ee9-20725153');
content_56f052d747d274_60070877($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-03-21 21:00:23
...
<?php if ($_valid && !is_callable('content_56f052d747d274_60070877')) {function content_56f052d747d274_60070877($_smarty_tpl) {?>
