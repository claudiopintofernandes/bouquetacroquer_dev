<?php /* Smarty version Smarty-3.1.19, created on 2016-03-09 06:58:06
         compiled from "/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/themes/alysum/modules/blockwishlist/views/templates/front/mywishlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:56135015056dfbb6e2556e8-91905401%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5416d2f000b183c0f10e2a8aefe8be9a22b0ae00' => 
    array (
      0 => '/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/themes/alysum/modules/blockwishlist/views/templates/front/mywishlist.tpl',
      1 => 1453302235,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '56135015056dfbb6e2556e8-91905401',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56dfbb6e3c3118_20329618',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56dfbb6e3c3118_20329618')) {function content_56dfbb6e3c3118_20329618($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/srv/data/web/vhosts/www.bouquetacroquer.fr/htdocs/tools/smarty/plugins/modifier.date_format.php';
?>
...
"><?php echo smartyTranslate(array('s'=>'My wishlists','mod'=>'blockwishlist'),$_smarty_tpl);?>
        ...
        <?php if ((!empty($_smarty_tpl->tpl_vars['current_wishlist']->value))) {?><span class="navigation-pipe"><?php echo $_smarty_tpl->tpl_vars['navigationPipe']->value;?>
</span><?php echo $_smarty_tpl->tpl_vars['current_wishlist']->value['name'];?>
<?php }?>
...
" />
					...
					<input type="text" id="name" name="name" class="inputTxt" value="<?php if (isset($_POST['name'])&&count($_smarty_tpl->tpl_vars['errors']->value)>0) {?><?php echo htmlspecialchars($_POST['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" />
